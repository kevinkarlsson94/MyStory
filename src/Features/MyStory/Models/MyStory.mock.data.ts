...
// NOTE: Was unable to get the image loader to work for Cypress tests, because of lack of time I will dupe the stories list and omit the image prop in order to use it in Cypress
export const storiesCypress: Story[] = [
  {
    id: 1,
    title: "High school",
    country: "Sweden",
